...
| lessons | lesson_append, lesson_list, lesson_get, lesson_remove, lesson_restore |
| shadow_review | shadow_review_run, shadow_review_status |
| candidate_reviewer | candidate_review_run, candidate_review_status |
| curator | curator_review, curator_review_status, skill_validate, curator_report_write, curator_restore |
