...
SKILL_REVIEW_PROMPT = (
    ...
    "Be ACTIVE — a rich thread usually yields at least one lesson, even "
...
COMBINED_REVIEW_PROMPT = (
    ...
    "note as appropriate.\n\n"
    "**Lessons**: how to handle this class of task. Did the user "
    "correct style, workflow, or approach? Did a non-trivial fix or "
    "technique emerge? If yes — PRIMARY: call lesson_append(title, "
    "body, summary, source=thread_id) to write into "
    "~/.threadkeeper/lessons.md (visible to every CLI). OPTIONAL "
    "additional Claude-only output: skill_manage(...) under "
